...
def get_all_posts():
    ...
    return render_template("index.html", all_posts=posts, is_logged=current_user.is_authenticated, admin=is_admin())
...
def show_post(post_id):
    ...
    return render_template("post.html", c_form=c_form, post=requested_post, gravatar=gravatar,
                           comments=all_comments, is_logged=current_user.is_authenticated)
...
def edit_post(post_id):
    ...
    return render_template("make-post.html", form=edit_form, is_logged=current_user.is_authenticated)
