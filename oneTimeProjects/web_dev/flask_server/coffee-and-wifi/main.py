...
class CafeForm(FlaskForm):
    ...
    cls_time = StringField("Closing Time e.g. 5:30PM", validators=[DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        row_data = [form.cafe.data, form.loc.data, form.op_time.data,
                    form.cls_time.data, form.rating.data, form.wifi_rating.data, form.power_rating.data]
